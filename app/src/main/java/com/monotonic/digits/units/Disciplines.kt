...
val disciplines = listOf(
        ...
        Discipline(R.string.discipline_carpentry, R.drawable.ic_hand_saw, listOf(u("m"), u("in"), u("ft"), u("°"))),
        Discipline(R.string.discipline_cooking, R.drawable.ic_telescope_black_24dp, listOf(u("g"), u("L"), u("lb"), u("tsp"), u("tbsp"), u("floz"), u("cup"), u("pt"), u("qt"), u("gal"))), // Fahrenheit, celsius
...
//        Discipline(R.string.discipline_fluids, R.drawable.ic_waves_black_24dp, listOf(u("Pa"))),
        ...
        Discipline(R.string.discipline_physics, R.drawable.ic_atom_black_24dp, listOf(u("g"), u("°"), u("rad"), u("Pa"), u("u"), u("N"), u("Hz"), u("Wb"), u("C"))),
