...
val disciplines = listOf(
        ...
        Discipline(R.string.discipline_basic_us, 0, listOf(u("in"), u("ft"), u("mi"), u("lb"))),
        ...
        Discipline(R.string.discipline_chemistry, R.drawable.ic_flask_black_24dp, listOf(u("mol"), u("m"), u("Pa"), u("atm"), u("Torr"))), // liters, kelvin, celsius
